  ...
  return (
    <header>
      ...
      >
        <div
          className={cn(
            "mx-auto mt-2 max-w-7xl px-6 rounded-2xl border border-transparent transition-all duration-300 lg:px-8",
            isScrolled &&
              "bg-background/50 max-w-5xl rounded-2xl border border-border backdrop-blur-lg lg:px-5"
          )}
        >
